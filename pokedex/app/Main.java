...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        TypeEffectivenessService effect = new TypeEffectivenessService("pokedex/dataset/files/matchups.csv");
            ...
            switch (optionMenu) {
                ...
                case 2:
                    ...
                    try {
                        ...
                        Menu.exibirMenuPokemon(pkmn, 30);
