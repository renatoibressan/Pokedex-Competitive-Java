...
import src.main.pokedex.builder.StatsBuilder;
import src.main.pokedex.domain.enums.Nature;
import src.main.pokedex.domain.enums.Typing;
import src.main.pokedex.exception.DadoInvalidoException;
import src.main.pokedex.serializer.PokemonSerializer;
...
public class Pokemon {
    ...
    public int statFromString(String valor) throws DadoInvalidoException {
        switch (valor.toLowerCase()) {
            ...
            case "ataque": return baseStats.getAttack();
            case "defesa": return baseStats.getDefense();
            case "ataque especial": return baseStats.getSpecialAttack();
            case "defesa especial": return baseStats.getSpecialDefense();
            case "velocidade": return baseStats.getSpeed();
